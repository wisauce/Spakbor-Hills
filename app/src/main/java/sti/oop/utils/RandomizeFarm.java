...
public class RandomizeFarm {
    ...
    int[] pondPosition = new int[4];
    int[] shippingBinPosition = new int[4];
    ...
    public void generateShippingBin() {
        ...
        randomizePosInterval(minRow,maxRow,minCol,maxCol,loop,start);
        int startRow = start[0];
        int startCol = start[1];

        // Acak Lokasi
        while ((!isArea2Tileto(farmMap,startRow,startCol,SHIPPINGBIN_X,SHIPPINGBIN_Y) || !isAreaFree(farmMap,startRow,startCol,SHIPPINGBIN_X,SHIPPINGBIN_Y)) && loop <70){
            randomizePosInterval(minRow,maxRow,minCol,maxCol,loop,start);
            startRow = start[0];
            startCol = start[1];
            loop++;
        ...
        shippingBinPosition[0] = startRow;
        shippingBinPosition[1] = startRow + SHIPPINGBIN_X;
        shippingBinPosition[2] = startCol;
        shippingBinPosition[3] = startCol + SHIPPINGBIN_Y;
    }
    ...
    public void generatePond() {
        ...
        pondPosition[0] = startRow;
        pondPosition[1] = startRow + POND_Y;
        pondPosition[2] = startCol;
        pondPosition[3] = startCol + POND_X;
    }
    ...
    public int[] getShippingBinLoc(){
        return this.shippingBinPosition;
    }

    public int[] getPondLoc(){
        return this.pondPosition;
    }
    ...
    public int[] randomizePosInterval(int minRow, int maxRow, int minCol, int maxCol,int loop, int[] start) {
        int row, col;
